...
class AddBus extends React.Component {
  ...
  AddBus = () => {
    axios
      .post(
        "http://localhost:65424/Api/Bus/Create2/",
        JSON.stringify(this.model)
      )
      // axios.post('http://localhost:65424/Api/Bus/Create/', {Name:this.state.Name,Brand:this.state.Brand,
  ...
  // test = () =>{
  //   axios.get('http://localhost:65424/Api/Bus/BussList')
  //         .then(response => {
  ...
  // }
  AddBus2 = () => {
    fetch("http://localhost:65424/Api/Bus/Create/", {
      mode: "no-cors",
      method: "post",
      headers: {
