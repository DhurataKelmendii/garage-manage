...
class EditBusGarage extends React.Component {
  constructor(props) {
    super(props);
  ...
  //   componentDidMount() {
  //       axios.get('http://localhost:65424/Api/BusGarage/GetById?id='+this.props.match.params.id)
  //           .then(response => {
  //               this.setState({
  ...
  onSubmit(e) {
    ...
    // axios.post('http://localhost:65424/Api/BusGarage/Update/'+this.props.match.params.id)
