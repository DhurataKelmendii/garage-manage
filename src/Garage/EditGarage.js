...
class EditGarage extends React.Component {
  constructor(props) {
    super(props);
  ...
  //   componentDidMount() {
  //       axios.get('http://localhost:65424/Api/Garage/GetById?id='+this.props.match.params.id)
  //           .then(response => {
  //               this.setState({
  ...
  onSubmit(e) {
    ...
    // axios.post('http://localhost:65424/Api/Garage/Update/'+this.props.match.params.id)
